...
public:
  Lambda2(T (*f)(U, V), U arg1, V arg2) : _f(f), _arg1(arg1), _arg2(arg2) {}

  Lambda2(T (*f)(U, V), U arg1) : _f(f), _arg1(arg1) {}
...
template <class T, class U> class Foreach : public Lambda1<T *, U *> {
  List<U> _list;
...
template <class T, class U> class Foreach2 : public Lambda1<T, U> {
  List<U> _list;
...
template <class T> T plus(T a, T b) { return a + b; }

template <class T, class U> Foreach<T, U> map(T *(*f)(U *)) {
...
Wrapper<int> *plus1w(Wrapper<int> *a) { return new Wrapper<int>(a->value + 1); }
