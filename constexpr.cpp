...
template <char Format, typename T> constexpr bool typeIsCorrect() {
  return false;
}

template <> constexpr bool typeIsCorrect<'s', const char *>() { return false; }

// template<typename t> constexpr bool typeIsCorrect<'s'>(const char* format,
// const char *);
